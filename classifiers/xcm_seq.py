...
from keras.layers import Activation, BatchNormalization, Dense, GlobalAveragePooling1D, Input, Reshape
...
def xcm_seq(input_shape, n_class, window_size, filters_num=128):
    ...
    z = Conv1D(filters=filters_num, kernel_size=int(window_size*n), strides=1, padding='same', name='1D_Final')(y)
